...
; A_IconTip := "Language Switching Context Menu Script Active. Switch language with Ctrl+' or Ctrl+Right Click"
; A_TrayMenu.Rename("1&", "Language Switch")  ; Changes default first menu item
